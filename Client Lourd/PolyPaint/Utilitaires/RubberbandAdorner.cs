...
namespace PolyPaint
{
    public class RubberbandAdorner : Adorner
    {
        ...
        {
            designerCanvas.SendSelectOperation(SelectType.DESELECT_ALL, null, Communication.IsConnected());
            ...
            foreach (Control item in designerCanvas.Children)
            {
                ...
                if (rubberBand.Contains(itemBounds) && item is ISelectable)
                {
                    ...
                    designerCanvas.SendSelectOperation(SelectType.SELECT, selectableItem, Communication.IsConnected());
                }
            }
        }
    }
